...
if os.path.exists(persistent_directory):
    ...
    raise FileNotFoundError(
        f"The directory {persistent_directory} does not exist. Please check your path."
    )

# Define embeddings model
embeddings = OpenAIEmbeddings(model="text-embedding-3-small")

# Load the vector store woth the embedding function
db = Chroma(
...
# This uses the LLM to help reformualte the question based on chat history
