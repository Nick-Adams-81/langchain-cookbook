...
# Soplits text into chunks based on a specified number of characters.
# Useful for consistent chunk sizes regardless of content structure.
print(f"\n--- Using Charater-based Splitting ---")
...
print("\n--- Using Recursive Character-based text splitting ---")
rec_char_text_splitter = RecursiveCharacterTextSplitter(
    chunk_size=1000, chunk_overlap=100
)
rec_char_docs = rec_char_text_splitter.split_documents(documents)
