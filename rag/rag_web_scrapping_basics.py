...
# Define current persistent directory
...
# Display information aboiut the split documents
print("\n--- Document Chunks Information ---")
print(f"Number of document chunks: {len(docs)}")
print(f"Sample chunk:\n{docs[0].page_content}")

# Step 3: Create embeddings for the document chunks
# OpenAIEmbeddings turns the text into numerical vectors that capture semantic meaning
