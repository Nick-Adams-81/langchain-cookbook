...
db_dir = os.path.join(currnet_dir, "db")
...
def create_vector_store():
    ...
    print(f"--- Finished creating vectore store in {persistent_directory} ---")
...
def query_vector_store(query):
    ...
    # Display the relevant docs with metadata
    print("\n--- Relevant Documents ---")
...
# Query the vector store with the user's query
